...
Best BPB: **1.9067** (6L/384d, RoPE, QK-norm, GeLU, variable-t [0.1-0.5] + ELBO weighting, stratified t sampling (8 strata), Muon optimizer, 3600s training, 33752 steps)
...
**Per-t diagnostics (3600s GeLU run, 33752 steps)**:
- t=0.05: CE=0.61
- t=0.10: CE=1.07
- t=0.20: CE=1.17
- t=0.30: CE=1.57
